...
/*
Package geoip_service is a reverse proxy.
...
func request_IPService_GetInfo_0(ctx context.Context, marshaler runtime.Marshaler, client IPServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_IPService_GetInfo_0(ctx context.Context, marshaler runtime.Marshaler, server IPServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IPRequest
	var metadata runtime.ServerMetadata
...
func RegisterIPServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IPServiceServer) error {
	...
	mux.Handle("POST", pattern_IPService_GetInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.IPService/GetInfo", runtime.WithHTTPPathPattern("/v1/ip"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_IPService_GetInfo_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_IPService_GetInfo_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterIPServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IPServiceClient) error {
	...
	mux.Handle("POST", pattern_IPService_GetInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.IPService/GetInfo", runtime.WithHTTPPathPattern("/v1/ip"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_IPService_GetInfo_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_IPService_GetInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "ip"}, ""))
)

var (
	forward_IPService_GetInfo_0 = runtime.ForwardResponseMessage
)
